...
const KeyboardAvoidingComponent = () => {
  ...
  <body class="container">
      <h1 fontface="Arial" align="center">${nome}</h1>
      <hr>
      <h2>Objetivo:</h2>
      <p>${objetivo}
      </p>
      ...
      <ul>
          ...
          `+`
          ${contarLinhas(habilidades) > 1 ? '<li>' + Linhas(habilidades, 1) + '</li>' + '<li>' + Linhas(habilidades, 2) + '</li>' + '<li>' + Linhas(habilidades, 3) + '</li>' + '<li>' + Linhas(habilidades, 4) + '</li>' + '<li>' + Linhas(habilidades, 5) + '</li>': ""}
      </ul>
      <hr>
      `
      +
      ...
      <ul>
          <li>${cursos}</li>
          `+`
          ${contarLinhas(cursos) > 1 ? '<li>' + Linhas(cursos, 1) + '</li>' + '<li>' + Linhas(cursos, 2) + '</li>' + '<li>' + Linhas(cursos, 3) + '</li>' + '<li>' + Linhas(cursos, 4) + '</li>' + '<li>' + Linhas(cursos, 5) + '</li>': ""}
      </ul>
      <hr>
      `
      +
      ...
      <ul>
          <li>${idiomas}</li>
          `+`
          ${contarLinhas(idiomas) > 1 ? '<li>' + Linhas(idiomas, 1) + '</li>' + '<li>' + Linhas(idiomas, 2) + '</li>' + '<li>' + Linhas(idiomas, 3) + '</li>' + '<li>' + Linhas(idiomas, 4) + '</li>' + '<li>' + Linhas(idiomas, 5) + '</li>': ""}
      </ul>
      <hr>
      `
      +
      ...
      <ul>
          <li>${experiencia}</li>
          `+`
          ${contarLinhas(experiencia) > 1 ? '<li>' + Linhas(experiencia, 1) + '</li>' + '<li>' + Linhas(experiencia, 2) + '</li>' + '<li>' + Linhas(experiencia, 3) + '</li>' + '<li>' + Linhas(experiencia, 4) + '</li>' + '<li>' + Linhas(experiencia, 5) + '</li>': ""}
      </ul>
  </body>
  </html> `;

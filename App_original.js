...
import Key from './SRC/components/KeyBordOriginal';
...
const salvarDados = async () => {
  try {
    await inserirDados(nome, objetivo, habilidades, formacao, cursos, idiomas, experiencia); // Chama a função inserirDados com os dados dos TextInput
    props.navigation.navigate('TelaPreview', { // Navega para a próxima tela após salvar os dados
      nome: nome,
      objetivo: objetivo,
